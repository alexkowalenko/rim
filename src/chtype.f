      LOGICAL FUNCTION CHTYPE(TYPE,ASCHR)
         USE Lexer, only : ASBLK, ASCOM, ASLPAR, ASRPAR, LA, LZ, UA, UZ
         USE Lexer, only : U0, U9, USCOR, UECH, LECH, PLSIGN, MNSIGN
         USE Lexer, only : DECIM, ATSIGN, PCSIGN, EQSIGN, GTSIGN, LTSIGN
         USE Lexer, only : SQUOTE, DQUOTE, ASCOLN
